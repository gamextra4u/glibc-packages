...
case $TERMUX_ARCH in
	"aarch64")
		TERMUX_ARCH32="arm"
		TERMUX_HOST_PLATFORM32="arm-linux-gnueabihf";;
	"x86_64")
		TERMUX_ARCH32="i686"
		TERMUX_HOST_PLATFORM32="i686-linux-gnu";;
	*)
		TERMUX_ARCH32=""
		TERMUX_HOST_PLATFORM32="";;
esac
...
termux_setup_build32() {
	export TERMUX_ARCH="$TERMUX_ARCH32"
	export TERMUX_HOST_PLATFORM="$TERMUX_HOST_PLATFORM32"
